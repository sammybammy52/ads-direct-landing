...
const CtaSection = () => {
  ...
  <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
    ...
    <Fade  right duration={1500} delay={300}>
      ...
      <a href="#" className="inline-flex items-center text-white hero-bg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-semibold rounded-lg text-sm px-5 py-4 text-center hover:scale-110 transition-all duration-300">
