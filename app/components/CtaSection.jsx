...
const CtaSection = () => {
  ...
  <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
    ...
    <Fade  right duration={1500} delay={300}>
      ...
      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-800"><span className='text-secondary'>Confused? </span> We can help you plan the perfect campaign!</h2>
      <p className="mb-6 font-lightt text-black-500 md:text-lg text-gray-800">Hire our expert media planners to find, plan and place your next promotion.</p>
