...
const CtaSection = () => {
  return (
    <section className="confused py-10">
  <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
    ...
    <Fade  right duration={1500} delay={300}>
      ...
      <p className="mb-6 font-light text-black-500 md:text-lg ">Hire our expert media planners to find, plan and place your next promotion.</p>
