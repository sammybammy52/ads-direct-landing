    ...
    <section className="bg-white mt-20">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <Fade left duration={1300}>
          ...
          <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-primary">
...
<div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-pink-100 lg:h-12 lg:w-12 ">
              <svg
                className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 "
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-yellow-100 lg:h-12 lg:w-12 ">
              <svg
                className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 "
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-violet-100 lg:h-12 lg:w-12 ">
              <svg
                className="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 "
                fill="currentColor"
                viewBox="0 0 20 20"
