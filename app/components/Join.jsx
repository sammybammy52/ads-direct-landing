...
const Join = () => {
  ...
  <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
    ...
    <Fade  right duration={1500} delay={300}>
      ...
      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-primary">Create a powerful brand <span className='text-secondary'>presence </span>  with <span className='text-secondary'>Adspoosh </span>  </h2>
      <p className="mb-6 font-lightt text-black-500 md:text-lg text-gray-800">The innovative tech startup revolutionizing the advertising industry with cutting-edge AI algorithms and data-driven targeting strategies...</p>
    ...
    <Fade left duration={1500} delay={100}>
      <Image className="h-[450px] object-contain rounded-xl moving-div dark:block" src={Desktop} alt="dashboard image" />
    </Fade>
